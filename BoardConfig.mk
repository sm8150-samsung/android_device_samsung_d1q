...
# FOD
TARGET_SURFACEFLINGER_FOD_LIB := //$(DEVICE_PATH):libfod_extension.d1q

# HIDL
DEVICE_FRAMEWORK_MANIFEST_FILE += $(DEVICE_PATH)/framework_manifest.xml

# Kernel
TARGET_KERNEL_CONFIG := lineage_d1q_defconfig
...
#TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):libinit_d1q
#TARGET_RECOVERY_DEVICE_MODULES := libinit_d1q
